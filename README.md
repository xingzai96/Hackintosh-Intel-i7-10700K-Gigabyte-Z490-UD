...
# Summary
Manage to successfully installed MacOS Catalina 10.15.6 on Gigabyte Z490 UD **with** Intel UHD Graphics 630 **using HDMI port** (**without** a dedicated graphic cards)
